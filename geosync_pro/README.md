...
## Quickstart (examples)
python -m geosync_pro.cli.run_validate --steps 500
python -m geosync_pro.cli.run_backtest --steps 500
python -m geosync_pro.cli.run_calibrate --data your_data.csv
