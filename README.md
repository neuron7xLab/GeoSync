...
| OOS walk-forward alpha | **claim retracted pending signed audit artefact** at `artifacts/audit/SCIENTIFIC_VERIFICATION_REPORT.json` (see [CLAIMS.md](CLAIMS.md) · audit 2026-04-30) | scientific-verification-report job |
