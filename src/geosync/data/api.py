...
"""Unified Data Access API for GeoSync strategies.

This module provides the single entry point for accessing market data
in GeoSync. All strategies, backtests, and live trading systems
...
Example:
    >>> from geosync.data.api import get_historical_window, load_historical_bars
    >>>
