...
This directory contains the adaptive optimization system for GeoSync's neuroscience-grounded AI architecture. The system provides automatic calibration and cross-neuromodulator balance optimization for optimal trading performance.
