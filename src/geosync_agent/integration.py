"""High-level orchestration translating agent actions into GeoSync orders."""
...
class AgentTradeOrchestrator:
    """Convert agent outputs into GeoSync SDK interactions."""
    ...
    def execute_action(
        ...
        """Translate *action* into GeoSync SDK calls."""
