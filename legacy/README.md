...
This directory contains code, configurations, and scripts that are no longer actively used in the GeoSync system but are preserved for historical reference and potential future reuse.
