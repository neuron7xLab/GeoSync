...
> **Мета.** Дати практичне, відтворюване пояснення методології FPM‑A (Phase/Regime Model — версія A) та її інтеграції в пайплайн GeoSync.
...
> Примітка: наведені числа — з відтворюваних джерел; власні бек‑тести GeoSync слід будувати у такій самій методології (data‑split, транзакційні витрати, затримка виконання, обмеження на шорти тощо).

---

## 8) Протокол бектесту FPM‑A у GeoSync
