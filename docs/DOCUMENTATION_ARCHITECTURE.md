...
*This document describes the "how and why" of GeoSync documentation architecture. For the "what" (inventory), see [DOCUMENTATION_SUMMARY.md](../DOCUMENTATION_SUMMARY.md).*
