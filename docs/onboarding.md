# Керівництво з онбордингу користувачів GeoSync

Цей документ допомагає новим користувачам швидко зрозуміти логіку роботи GeoSync та почати ефективно використовувати платформу у виробничих або дослідницьких сценаріях.

## 1. Основні концепти

GeoSync — це модульна платформа для побудови, тестування та запуску алгоритмічних торгових стратегій. Щоб швидко зорієнтуватися, запам'ятайте три ключові компоненти:
...
| --- | --- | --- | --- |
| 1. Орієнтація | Зрозуміти, що вміє GeoSync | Перегляньте [огляд архітектури](ARCHITECTURE.md) та [FAQ](faq.md) | `docs/ARCHITECTURE.md`, `docs/faq.md` |
...
Готово! Ви пройшли базовий онбординг GeoSync. Далі комбінуйте модулі та експериментуйте зі стратегіями, поступово переходячи до продакшн-релізів.
