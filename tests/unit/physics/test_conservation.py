...
class TestConservationLaws:
    ...
    def test_energy_conservation_within_tolerance(self):
        ...
        energy_before = 100.0
        energy_after = 100.5
        conserved, change = check_energy_conservation(energy_before, energy_after, tolerance=0.01)
        assert conserved is True
    ...
    def test_momentum_conservation_perfect(self):
        ...
        momentum_after = 50.0
        conserved, change = check_momentum_conservation(momentum_before, momentum_after)
        assert conserved is True
        assert change == 0.0
