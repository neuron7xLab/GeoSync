...
GeoSync Risk Guardian, generating metrics that demonstrate monetary value.
...
def print_experiment_summary(result: SimulationResult, strategy_name: str) -> None:
    ...
    print("\n" + "=" * 70)
    print("           GEOSYNC RISK GUARDIAN - PROOF OF VALUE")
    print("=" * 70)
...
def main(
    ...
    This script demonstrates the monetary value of GeoSync Risk Guardian
