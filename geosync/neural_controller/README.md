...
Copy the `geosync/neural_controller/` directory into your project or install as a package. Dependencies: `numpy`, `pyyaml`. Python 3.11+.

## Quickstart

```python
from geosync.neural_controller import (
    MarketDataAdapter,
...
neural = NeuralMarketController.from_yaml("geosync/neural_controller/config/neural_params.yaml")
...
Unit and property tests live in `geosync/neural_controller/tests/`. Run with:

```bash
pytest geosync/neural_controller/tests
```
